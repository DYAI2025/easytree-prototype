...
export const PROBLEM_STATUS: Record<ProblemCode, number> = {
  ...
  // Wie STALE_REVISION ein echter Nebenlaeufigkeitskonflikt, nur auf dem
  // Einsatz statt auf dem Baustellentag - deshalb ebenfalls 409.
  ENGAGEMENT_VERSION_CONFLICT: 409,
  ENGAGEMENT_SHRINK_NOT_ALLOWED: 422,
  ENGAGEMENT_PERIOD_MODE_MISMATCH: 422,
